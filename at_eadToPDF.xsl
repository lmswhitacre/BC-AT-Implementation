            ...
            <fo:page-sequence master-reference="toc">                                               
                ...
                <fo:table>
                    ...
                    <fo:table-body>
                        <fo:table-row>
                            <fo:table-cell>
                                <fo:block color="gray" font-size="8pt" text-align="left" font-family="Times"> 
                                    <xsl:value-of select="$pageHeader"/> 
                                </fo:block>   
                            </fo:table-cell>                                               
                            <fo:table-cell>    
                                <fo:block text-align="right" color="gray" font-size="8pt" font-family="Times">
            ...
            <xsl:choose>
                ...
                <xsl:when test="child::*/ead:container/@parent">
                    <fo:table-row background-color="{$colorClass}" border-bottom="1pt solid #fff">
                        ...
                        <fo:table-cell number-columns-spanned="5" padding="4pt" border-top="1pt solid gray" border-bottom="1pt solid gray">
                                          ...
                                          <xsl:for-each select="child::*/ead:container[@label]">
                                              ...
                                              <fo:table-cell> 
                                                  <xsl:choose>
                                                      ...
                                                      <xsl:when test="$container = 2"><xsl:attribute name="number-columns-spanned">2</xsl:attribute></xsl:when>
                                                      <xsl:when test="$container = 3"><xsl:attribute name="number-columns-spanned">3</xsl:attribute></xsl:when>
                                              ...
                                              <xsl:for-each select="../ead:container[@parent = $id] | ../ead:container[@id = $id]">
                                                  <fo:table-cell>
                                                      <fo:block font-weight="bold" margin-top=".1in">
                                                          <xsl:value-of select="@type"/>
                                                          <xsl:text> </xsl:text>
                                                          <xsl:value-of select="."/>
                                                      </fo:block>                                                                                                                    
